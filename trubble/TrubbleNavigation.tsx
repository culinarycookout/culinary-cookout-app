    ...
    <>
      <nav className="fixed bottom-0 left-0 right-0 bg-zinc-950 border-t border-zinc-800 py-4 px-4 z-50 shadow-2xl md:hidden">
        <div className="flex items-center justify-around max-w-md mx-auto">
          <Link href="/cart" className="flex flex-col items-center transition text-zinc-400 hover:text-white"> {/* Fixed: Removed /trubble */}
          ...
          <Link href="/menu" className="flex items-center justify-center transition opacity-60 hover:opacity-100"> {/* Fixed: Removed /trubble */}
            <span className="text-3xl">🍸</span>
          </Link>
