...
export default function CategoryPage() {
  ...
  const categoryItem = FOOD_MENU_ITEMS.find((item) => item.id === categoryId);
    ...
    <div className="min-h-screen bg-black text-white pb-32">
      <div className="max-w-6xl mx-auto p-4">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold text-red-600 tracking-wider uppercase">{categoryItem.name}</h1>
            <p className="text-zinc-400 mt-2">{categoryItem.description}</p>
          </div>
