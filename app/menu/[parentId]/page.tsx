    ...
    <div className="min-h-screen bg-black text-white pb-32">
      <div className="max-w-6xl mx-auto p-4">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold text-red-600 tracking-wider uppercase">
              {parentItem.name}
            </h1>
          ...
          <Link
            href="/"
            className="bg-zinc-800 hover:bg-zinc-700 text-white px-4 py-2 rounded-lg font-bold transition-colors"
          >
            ↩️ Back To Menu
          </Link>
        </div>
          ...
          {parentItem.subMenu.map((subItem) => (
            ...
            >
              ...
              <div className="p-3 md:p-4 flex flex-col flex-1">
                ...
                <h3 className="font-bold text-sm md:text-lg leading-tight break-words mb-2">
                  {subItem.name}
                </h3>
