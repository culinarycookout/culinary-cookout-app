...
export const FOOD_MENU_ITEMS: MenuItem[] = [
  ...
  {
    id: "birds-battered-fried-chicken", name: "BATTERED FRIED CHICKEN", description: "The ultimate crunch.", price: 0, category: "BIRDS", image: "PLACEHOLDER_IMAGE_URL",
    subMenu: [
      { id: "whole", name: "WHOLE", description: "The full bird.", image: "PLACEHOLDER_IMAGE_URL", price: 0 },
      { id: "half", name: "HALF", description: "Half the bird.", image: "PLACEHOLDER_IMAGE_URL", price: 0 },
      { id: "drums", name: "DRUMS", description: "Play this drum with your teeth.", image: "PLACEHOLDER_IMAGE_URL", price: 0 },
  ...
  {
    id: "birds-fried-chicken", name: "FRIED CHICKEN", description: "Go half, or go whole.", price: 0, category: "BIRDS", image: "PLACEHOLDER_IMAGE_URL",
    subMenu: [
      { id: "whole", name: "WHOLE", description: "The full bird.", image: "PLACEHOLDER_IMAGE_URL", price: 0 },
      { id: "half", name: "HALF", description: "Half the bird.", image: "PLACEHOLDER_IMAGE_URL", price: 0 },
      { id: "drums", name: "DRUMS", description: "Play this drum with your teeth.", image: "PLACEHOLDER_IMAGE_URL", price: 0 },
  ...
  {
    id: "birds-air-fried-turkey", name: "AIR-FRIED TURKEY", description: "He got fried because he couldn't fly.", price: 0, category: "BIRDS", image: "PLACEHOLDER_IMAGE_URL",
    subMenu: [
      { id: "whole", name: "WHOLE", description: "The full bird.", image: "PLACEHOLDER_IMAGE_URL", price: 0 },
      { id: "half", name: "HALF", description: "Half the bird.", image: "PLACEHOLDER_IMAGE_URL", price: 0 },
  ...
  {
    id: "birds-battered-turkey", name: "BATTERED TURKEY", description: "Crispy, golden, unforgettable.", price: 0, category: "BIRDS", image: "PLACEHOLDER_IMAGE_URL",
    subMenu: [
      { id: "whole", name: "WHOLE", description: "The full bird.", image: "PLACEHOLDER_IMAGE_URL", price: 0 },
      { id: "half", name: "HALF", description: "Half the bird.", image: "PLACEHOLDER_IMAGE_URL", price: 0 },
      { id: "drums", name: "DRUMS", description: "Fried & fit for a feast.", image: "PLACEHOLDER_IMAGE_URL", price: 0 },
